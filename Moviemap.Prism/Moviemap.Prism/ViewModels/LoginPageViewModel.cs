...
namespace Moviemap.Prism.ViewModels
{
    public class LoginPageViewModel : ViewModelBase
    {
        ...
        private async void LoginAsync()
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert(Languages.Error, Languages.AdminCantLogIn, Languages.Accept);
                IsRunning = false;
                IsEnabled = true;
                return;
            }
            ...
            await _navigationService.NavigateAsync("/MoviemapMasterDetailPage/NavigationPage/CinemasPage");
            Password = string.Empty;
